 ...
 */
export async function authLoginUser(email: string, password: string): Promise<Response> {
...
export async function authGetUserAccount(token: Token): Promise<Response> {
	return api.get(`account/signin/${token.id}`, {
		method: 'GET',
		headers: {
