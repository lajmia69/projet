...
function LessonsView() {
    ...
    const handleLanguageChange = (e: SelectChangeEvent) => setSelectedLanguage(e.target.value);
    const handleModuleChange = (e: SelectChangeEvent) => setSelectedModule(e.target.value);

    if (isUserLoading || isLessonsLoading) return <FuseLoading />;
