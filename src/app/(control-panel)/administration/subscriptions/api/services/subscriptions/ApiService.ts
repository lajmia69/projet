...
import { Subscription, SubscriptionsResponse } from '@/app/(control-panel)/administration/accounts/api/types';
...
export const subscriptionsApi = {
  ...
  createSubscription: async (token: Token, subscription: Omit<Subscription, 'id'>): Promise<Subscription> => {
    return api
